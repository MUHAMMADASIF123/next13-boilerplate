  ...
  <section className="flex h-screen items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
    <div className="w-full max-w-2xl space-y-8">
      ...
      <div className=' shadow-sm space-y-px bg-white p-6 border border-2 border-red-800 rounded-[20px]'>
        <div>
          <h2 className="mt-6 text-center text-[36px] md:text-[48px] font-extrabold text-red-900">
          Forgot Password
          </h2>
          <p className="mt-2 text-center text-[20px] text-black-600">
          Enter your email address below. If there is a user account
associated with that email, you will receive an email with
further instructions.
        ...
        <form className="mt-8 space-y-6 relative" action="#" method="POST">
          ...
          <label className='text-22px font-bold'>Email Address:</label>
            <input type="text" placeholder='Enter Email Address:' className='w-full py-4 px-12 rounded border border-gray-400 '></input>
          </div>
